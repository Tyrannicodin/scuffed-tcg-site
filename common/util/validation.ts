...
function validatePassword(password: string, retyped: string | null): passwordResultT {
...
function getPasswordError(message: passwordResultT): string {
    switch (message) {
        case 'no_match':
...
function validateUsername(username: string): usernameResultT {
...
function getUsernameError(message: usernameResultT): string {
    switch (message) {
        case 'long':
...
function getEmailError(valid: boolean) {
